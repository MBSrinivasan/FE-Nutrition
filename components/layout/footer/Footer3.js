      ...
      <div>
        <div className="mainBorderFooter w-full bg-black">
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col span={4}> <div className=" text-start">
                <div className="text-start text-[24px] text-[#FAFAFA] font-bold mb-[24px]">
                Quick Link
                </div>
                <div className="text-start text-[16px] text-[#FAFAFA] font-normal mb-[16px]">
              ...
              Social Media
                ...
                <div className="icon-social-linksFooter">
                        <ul>
                          <li>
                            <Link href="#">
                            <img src="/assets/images/icons-images/Icon-Facebook.svg" alt="" />
                            
                            </Link>
                          </li>
                          <li>
                            <Link href="#" className="ml1">
                            <img src="/assets/images/icons-images/Group.svg" alt="" />
                            </Link>
                          </li>
                          <li>
                            <Link href="#" className="ml1">
                            <img src="/assets/images/icons-images/Group (1).svg" alt="" />
                            </Link>
                          </li>
                          <li>
                            <Link href="#" className="ml1">
                            <img src="/assets/images/icons-images/Icon-Linkedin.svg" alt="" />
                            </Link>
                          </li>
                        </ul>
                      </div>
