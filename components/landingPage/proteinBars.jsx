...
export default function ProteinBars() {
  return (
    <>
      <div className="welcome4-section-area2">
        ...
        <div className="container-fluid">
          <div className="row align-items-center">
            ...
            >
              <div className="welcome4-textarea flex justify-center items-center flex-col">
                <div className="flex justify-center">
                    <IconBorder icon={<SearchOutlined style={{color:"#7A1F3D", fontSize:"24px"}}/>} backgroundColor="#FFDBE7" height="44px" width="50px"/>
              ...
              <div className="welcome4-positionalarea">
                <div className="imag4">
                  <div className="ima1-4">
                    <img
                      src="/assets/images/allimages/laptop.svg"
                      alt=""
