...
export default function VendorHeaderNav({ children }) {
  ...
  const menuItems = React.useMemo(
    () => [
      {
        text: "Dashboard",
        iconSrc: "/assets/images/allimages/dashboard.svg",
        iconAlt: "Dashboard",
        index: 0,
        path: "/vendor/home",
      },
      {
        text: "Profile",
        iconSrc: "/assets/images/allimages/profile.svg",
        iconAlt: "Profile",
        index: 1,
        path: "/vendor/profile",
      },
      {
        ...
        iconSrc: "/assets/images/allimages/my products.svg",
        iconAlt: "Products",
        index: 2,
        path: "/vendor/products-services",
      },
      {
        text: "Messages",
        iconSrc: "/assets/images/allimages/messages.svg",
        iconAlt: "Messages",
        index: 3,
      ...
      {
        text: "My Projects",
        iconSrc: "/assets/images/allimages/my projects.svg",
        iconAlt: "Projects",
        index: 4,
        path: "/vendor/my-projects",
      },
    ],
    []
  );
  ...
  const bottomMenuItems = React.useMemo(
    () => [
      {
        text: "Calendar",
        iconSrc: "/assets/images/allimages/calender.svg",
        iconAlt: "Calendar",
        index: 5,
      ...
      {
        text: "Sourcing",
        iconSrc: "/assets/images/allimages/sourcing.svg",
        iconAlt: "Sourcing",
        index: 6,
